...
function ResumeDisplayPage() {
  ...
  // Step 2: Parse the outer JSON string to get the inner JSON string
  const innerJsonString = JSON.parse(dataString);

  // Step 3: Parse the inner JSON string to get the actual resume data object
  const resumeData = JSON.parse(innerJsonString);
